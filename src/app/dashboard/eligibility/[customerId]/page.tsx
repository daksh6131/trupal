        ...
        {customer.cibilScore && customer.cibilScore > 0 ? <>
            ...
            {eligibleCards.length > 0 ? <>
                ...
                <div className="mt-8 flex justify-center">
                  <button onClick={handleWhatsAppShare} disabled={selectedCards.length === 0 || isSharing} className={cn("inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2", selectedCards.length > 0 && !isSharing ? "bg-green-600 hover:bg-green-700 focus:ring-green-500" : "bg-gray-400 cursor-not-allowed")}>
                    {isSharing ? <>
