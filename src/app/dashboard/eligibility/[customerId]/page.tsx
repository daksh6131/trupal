                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4">
                        ...
                        <div className="md:col-span-3 p-6">
                          ...
                          <div className="mt-6 flex items-center space-x-3">
                            ...
                            <button onClick={() => handleShareSingleCard(card)} className="inline-flex items-center px-3 py-2 border border-green-300 rounded-md text-sm font-medium bg-green-50 text-green-700 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
