...
export default function ConnectionStatus() {
  ...
  if (isConnected === null) {
    return (
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm bg-gray-100 text-gray-700">
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm bg-red-50 text-red-700">
