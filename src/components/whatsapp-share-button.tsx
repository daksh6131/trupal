...
export default function WhatsAppShareButton({
  ...
  return <button onClick={handleShare} disabled={isSharing || disabled} className={cn('inline-flex items-center justify-center font-medium border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors', sizeClasses[size], variantClasses[variant], (isSharing || disabled) && 'opacity-70 cursor-not-allowed', className)} type="button" data-unique-id="58425468-a168-418d-bce3-691b06449f7b" data-loc="77:9-77:390" data-file-name="components/whatsapp-share-button.tsx">
      {isSharing ? <>
          <svg className="animate-spin -ml-1 mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" data-unique-id="efddfec0-c35b-4360-bc7a-f08c4c8f6155" data-loc="79:10-79:126" data-file-name="components/whatsapp-share-button.tsx">
            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          </svg>
          Sharing...
        </> : children || <>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="currentColor" viewBox="0 0 24 24" data-unique-id="47e707ac-0964-4550-9763-12824d7af6e5" data-loc="85:10-85:115" data-file-name="components/whatsapp-share-button.tsx">
