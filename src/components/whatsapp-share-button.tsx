...
export default function WhatsAppShareButton({
  ...
  return (
    <button
      ...
      disabled={isSharing}
      className={cn(
        'inline-flex items-center justify-center font-medium border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors',
        sizeClasses[size],
